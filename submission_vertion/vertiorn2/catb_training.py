...
#merge the trainset for 2016
train2016 = train_df2016.merge(properties, how='left', on='parcelid')
train2017 = train_df2017.merge(properties, how='left', on='parcelid')
train_df = pd.concat([train2016,train2017])
train_df = add_date_features(train_df)

#merge the trainset for 2017
train2016 = train_df2016.merge(properties1, how='left', on='parcelid')
train2017 = train_df2017.merge(properties1, how='left', on='parcelid')
train_df1 = pd.concat([train2016,train2017])
train_df1 = add_date_features(train_df1)
...
X_train1 = train_df1[train_features]
y_train1 = train_df1.logerror
